...
function _quast-lg.py {
    ...
    _arguments -C \
        ...
        '(-m --min-contig)'{-m,--min-contig}'[Lower threshold for contig length \[default: 3000\]]' \
        ...
        '(-f --gene-finding)'{-f,--gene-finding}'[Predict genes using GeneMark-ES]' \
        ...
        '(-i --min-alignment)'{-i,--min-alignment}'[The minimum alignment length \[default: 500\]]' \
        ...
        '(-x --extensive-mis-size)'{-x,--extensive-mis-size}'[Lower threshold for extensive misassembly size. All relocations with inconsistency less than extensive-mis-size are counted as local misassemblies \[default: 7000\]]' \
