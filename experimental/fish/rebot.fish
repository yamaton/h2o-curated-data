...
complete -c rebot -s D -l doc -d 'Set the documentation of the top level suite.' -x
complete -c rebot -s M -l metadata -d 'Set metadata of the top level suite.' -x
...
complete -c rebot -l logtitle -d 'Title for the generated log file.' -x
complete -c rebot -l reporttitle -d 'Title for the generated report file.' -x
complete -c rebot -l reportbackground -d 'Background colors to use in the report file.' -x
complete -c rebot -s L -l loglevel -d 'Threshold for selecting messages.' -x
...
complete -c rebot -l expandkeywords -d 'Matching keywords will be automatically expanded in the log file.' -x
...
complete -c rebot -s C -l consolecolors -d 'Use colors on console output or not.' -x
