...
complete -c sqlite-utils -n "__fish_seen_subcommand_from bulk" -l delimiter -d 'Delimiter to use for CSV files' -x
...
complete -c sqlite-utils -n "__fish_seen_subcommand_from insert" -l delimiter -d 'Delimiter to use for CSV files' -x
...
complete -c sqlite-utils -n "__fish_seen_subcommand_from insert-files" -l name -d 'File name to use' -x
...
complete -c sqlite-utils -n "__fish_seen_subcommand_from upsert" -l delimiter -d 'Delimiter to use for CSV files' -x
