...
complete -c ag -s "L" -l "files-without-matches" -d "Only print the names of files that don\180t contain matches."
...
complete -c ag -l "one-device" -d "When recursing directories, don\180t scan dirs that reside on other storage devices."
...
complete -c ag -l "passthrough" -l "passthru" -d "When searching a stream, print all lines even if they don\180t match."
...
complete -c ag -l "vimgrep" -d "Output results in the same form as Vim\180s :vimgrep /pattern/g"
