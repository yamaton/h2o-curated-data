...
complete -c ansible-config -n "not __fish_seen_subcommand_from list dump view init" -s v -l verbose -d 'verbose mode (-vvv for more, -vvvv to enable connection debugging)'
...
complete -c ansible-config -n "__fish_seen_subcommand_from list" -s v -l verbose -d 'verbose mode (-vvv for more, -vvvv to enable connection debugging)'
...
complete -c ansible-config -n "__fish_seen_subcommand_from dump" -s v -l verbose -d 'verbose mode (-vvv for more, -vvvv to enable connection debugging)'
...
complete -c ansible-config -n "__fish_seen_subcommand_from view" -s v -l verbose -d 'verbose mode (-vvv for more, -vvvv to enable connection debugging)'
...
complete -c ansible-config -n "__fish_seen_subcommand_from init" -s v -l verbose -d 'verbose mode (-vvv for more, -vvvv to enable connection debugging)'
