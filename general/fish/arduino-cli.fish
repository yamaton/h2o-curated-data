...
complete -c arduino-cli -n "not __fish_seen_subcommand_from board burn-bootloader cache compile completion config core daemon debug lib monitor outdated sketch update upgrade upload version" -l config-file -d 'The custom config file (if not specified the default will be used).' -x
...
complete -c arduino-cli -n "not __fish_seen_subcommand_from board burn-bootloader cache compile completion config core daemon debug lib monitor outdated sketch update upgrade upload version" -l log-file -d 'Path to the file where logs will be written.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from board" -l config-file -d 'The custom config file (if not specified the default will be used).' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from board" -l log-file -d 'Path to the file where logs will be written.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from burn-bootloader" -l config-file -d 'The custom config file (if not specified the default will be used).' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from burn-bootloader" -l log-file -d 'Path to the file where logs will be written.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from cache" -l config-file -d 'The custom config file (if not specified the default will be used).' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from cache" -l log-file -d 'Path to the file where logs will be written.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from compile" -l build-cache-path -d 'Builds of \'core.a\' are saved into this path to be cached and reused.' -x
complete -c arduino-cli -n "__fish_seen_subcommand_from compile" -l build-path -d 'Path where to save compiled files.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from compile" -l libraries -d 'List of custom libraries dir paths separated by commas.' -x
complete -c arduino-cli -n "__fish_seen_subcommand_from compile" -l library -d 'List of paths to libraries root folders.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from compile" -l output-dir -d 'Save build artifacts in this directory.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from compile" -l config-file -d 'The custom config file (if not specified the default will be used).' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from compile" -l log-file -d 'Path to the file where logs will be written.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from completion" -l config-file -d 'The custom config file (if not specified the default will be used).' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from completion" -l log-file -d 'Path to the file where logs will be written.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from config" -l config-file -d 'The custom config file (if not specified the default will be used).' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from config" -l log-file -d 'Path to the file where logs will be written.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from core" -l config-file -d 'The custom config file (if not specified the default will be used).' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from core" -l log-file -d 'Path to the file where logs will be written.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from daemon" -l config-file -d 'The custom config file (if not specified the default will be used).' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from daemon" -l log-file -d 'Path to the file where logs will be written.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from debug" -l input-dir -d 'Directory containing binaries for debug.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from debug" -l config-file -d 'The custom config file (if not specified the default will be used).' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from debug" -l log-file -d 'Path to the file where logs will be written.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from lib" -l config-file -d 'The custom config file (if not specified the default will be used).' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from lib" -l log-file -d 'Path to the file where logs will be written.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from monitor" -l config-file -d 'The custom config file (if not specified the default will be used).' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from monitor" -l log-file -d 'Path to the file where logs will be written.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from outdated" -l config-file -d 'The custom config file (if not specified the default will be used).' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from outdated" -l log-file -d 'Path to the file where logs will be written.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from sketch" -l config-file -d 'The custom config file (if not specified the default will be used).' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from sketch" -l log-file -d 'Path to the file where logs will be written.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from update" -l config-file -d 'The custom config file (if not specified the default will be used).' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from update" -l log-file -d 'Path to the file where logs will be written.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from upgrade" -l config-file -d 'The custom config file (if not specified the default will be used).' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from upgrade" -l log-file -d 'Path to the file where logs will be written.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from upload" -l input-dir -d 'Directory containing binaries to upload.' -x
complete -c arduino-cli -n "__fish_seen_subcommand_from upload" -s i -l input-file -d 'Binary file to upload.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from upload" -l config-file -d 'The custom config file (if not specified the default will be used).' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from upload" -l log-file -d 'Path to the file where logs will be written.' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from version" -l config-file -d 'The custom config file (if not specified the default will be used).' -x
...
complete -c arduino-cli -n "__fish_seen_subcommand_from version" -l log-file -d 'Path to the file where logs will be written.' -x
