...
complete -c bc  -d "The result is the negation of the expression." -x
complete -c bc  -d "The variable is decremented by one and the new value is the result of the expression." -x
