...
complete -c buildah -n "not __fish_seen_subcommand_from add bud commit config containers copy from images info inspect login logout manifest mount pull push rename rm rmi run tag umount unshare version" -l registries-conf -d 'path to registries.conf file (not usually used)' -x
complete -c buildah -n "not __fish_seen_subcommand_from add bud commit config containers copy from images info inspect login logout manifest mount pull push rename rm rmi run tag umount unshare version" -l registries-conf-dir -d 'path to registries.conf.d directory (not usually used)' -x
complete -c buildah -n "not __fish_seen_subcommand_from add bud commit config containers copy from images info inspect login logout manifest mount pull push rename rm rmi run tag umount unshare version" -l root -d 'storage root dir (default "/var/lib/containers/storage")' -x
complete -c buildah -n "not __fish_seen_subcommand_from add bud commit config containers copy from images info inspect login logout manifest mount pull push rename rm rmi run tag umount unshare version" -l runroot -d 'storage state dir (default "/run/containers/storage")' -x
...
complete -c buildah -n "__fish_seen_subcommand_from add" -l contextdir -d 'context directory path' -x
complete -c buildah -n "__fish_seen_subcommand_from add" -l from -d 'use the specified container\'s or image\'s root directory as the source root directory' -x
complete -c buildah -n "__fish_seen_subcommand_from add" -s h -l help -d 'help for add'
complete -c buildah -n "__fish_seen_subcommand_from add" -l ignorefile -d 'path to .dockerignore file' -x
...
complete -c buildah -n "__fish_seen_subcommand_from bud" -l authfile -d 'path of the authentication file.' -x
...
complete -c buildah -n "__fish_seen_subcommand_from bud" -l cert-dir -d 'use certificates at the specified path to access the registry' -x
...
complete -c buildah -n "__fish_seen_subcommand_from bud" -l from -d 'image name used to replace the value in the first FROM instruction in the Containerfile' -x
...
complete -c buildah -n "__fish_seen_subcommand_from bud" -l ignorefile -d 'path to an alternate .dockerignore file' -x
...
complete -c buildah -n "__fish_seen_subcommand_from bud" -l network -d '\'private\', \'none\', \'ns:path\' of network namespace to join, or \'host\'' -x
...
complete -c buildah -n "__fish_seen_subcommand_from bud" -l secret -d 'secret file to expose to the build' -x
...
complete -c buildah -n "__fish_seen_subcommand_from commit" -l authfile -d 'path of the authentication file.' -x
complete -c buildah -n "__fish_seen_subcommand_from commit" -l cert-dir -d 'use certificates at the specified path to access the registry' -x
...
complete -c buildah -n "__fish_seen_subcommand_from commit" -l encryption-key -d 'key with the encryption protocol to use needed to encrypt the image (e.g. jwe:/path/to/key.pem)' -x
...
complete -c buildah -n "__fish_seen_subcommand_from commit" -l iidfile -d 'Write the image ID to the file' -x
...
complete -c buildah -n "__fish_seen_subcommand_from config" -s v -l volume -d 'add default volume path to be created for containers based on image (default [])' -x
...
complete -c buildah -n "__fish_seen_subcommand_from copy" -l contextdir -d 'context directory path' -x
complete -c buildah -n "__fish_seen_subcommand_from copy" -l from -d 'use the specified container\'s or image\'s root directory as the source root directory' -x
complete -c buildah -n "__fish_seen_subcommand_from copy" -s h -l help -d 'help for copy'
complete -c buildah -n "__fish_seen_subcommand_from copy" -l ignorefile -d 'path to .dockerignore file' -x
...
complete -c buildah -n "__fish_seen_subcommand_from from" -l authfile -d 'path of the authentication file.' -x
...
complete -c buildah -n "__fish_seen_subcommand_from from" -l cert-dir -d 'use certificates at the specified path to access the registry' -x
complete -c buildah -n "__fish_seen_subcommand_from from" -l cgroup-parent -d 'optional parent cgroup for the container' -x
complete -c buildah -n "__fish_seen_subcommand_from from" -l cidfile -d 'write the container ID to the file' -x
...
complete -c buildah -n "__fish_seen_subcommand_from from" -l network -d '\'private\', \'none\', \'ns:path\' of network namespace to join, or \'host\'' -x
...
complete -c buildah -n "__fish_seen_subcommand_from login" -l authfile -d 'path of the authentication file.' -x
complete -c buildah -n "__fish_seen_subcommand_from login" -l cert-dir -d 'use certificates at the specified path to access the registry' -x
...
complete -c buildah -n "__fish_seen_subcommand_from logout" -l authfile -d 'path of the authentication file.' -x
...
complete -c buildah -n "__fish_seen_subcommand_from pull" -l authfile -d 'path of the authentication file.' -x
complete -c buildah -n "__fish_seen_subcommand_from pull" -l cert-dir -d 'use certificates at the specified path to access the registry' -x
...
complete -c buildah -n "__fish_seen_subcommand_from push" -l authfile -d 'path of the authentication file.' -x
complete -c buildah -n "__fish_seen_subcommand_from push" -l cert-dir -d 'use certificates at the specified path to access the registry' -x
complete -c buildah -n "__fish_seen_subcommand_from push" -l creds -d 'use [username[:password]] for accessing the registry' -x
complete -c buildah -n "__fish_seen_subcommand_from push" -l digestfile -d 'after copying the image, write the digest of the resulting image to the file' -x
...
complete -c buildah -n "__fish_seen_subcommand_from push" -l encryption-key -d 'key with the encryption protocol to use needed to encrypt the image (e.g. jwe:/path/to/key.pem)' -x
complete -c buildah -n "__fish_seen_subcommand_from push" -s f -l format -d 'manifest type (oci, v2s1, or v2s2) to use when saving image using the \'dir:\' transport (default is manifest type of source)' -x
...
complete -c buildah -n "__fish_seen_subcommand_from run" -l mount -d 'Attach a filesystem mount to the container (default [])' -x
complete -c buildah -n "__fish_seen_subcommand_from run" -l network -d '\'private\', \'none\', \'ns:path\' of network namespace to join, or \'host\'' -x
