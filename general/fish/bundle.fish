...
complete -c bundle -n "__fish_seen_subcommand_from install" -l "deployment" -d "In deployment mode, Bundler will \180roll-out\180 the bundle for production or CI use."
...
complete -c bundle -n "__fish_seen_subcommand_from install" -l "full-index" -d "Bundler will not call Rubygems\180 API endpoint (default) but download and cache a (currently big) index file of all gems."
...
complete -c bundle -n "__fish_seen_subcommand_from install" -l "no-prune" -d "Don\180t remove stale gems from the cache when the installation finishes."
...
complete -c bundle -n "__fish_seen_subcommand_from install" -l "system" -d "Installs the gems specified in the bundle to the system\180s Rubygems location."
...
complete -c bundle -n "__fish_seen_subcommand_from binstubs" -l "shebang" -d "Specify a different shebang executable name than the default (default \180ruby\180)"
...
complete -c bundle -n "__fish_seen_subcommand_from gem" -l "linter" -d "Specify the linter and code formatter that Bundler should add to the project\180s development dependencies." -r
