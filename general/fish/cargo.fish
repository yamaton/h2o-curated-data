...
complete -c cargo -n "not __fish_seen_subcommand_from build check clean doc new init add run test bench update search publish install uninstall" -s "V" -l "version" -d "Print version info and exit"
complete -c cargo -n "not __fish_seen_subcommand_from build check clean doc new init add run test bench update search publish install uninstall" -l "list" -d "List installed commands"
complete -c cargo -n "not __fish_seen_subcommand_from build check clean doc new init add run test bench update search publish install uninstall" -l "explain" -d "Run `rustc --explain CODE`" -x
complete -c cargo -n "not __fish_seen_subcommand_from build check clean doc new init add run test bench update search publish install uninstall" -s "v" -l "verbose" -d "Use verbose output (-vv very verbose/build.rs output)"
complete -c cargo -n "not __fish_seen_subcommand_from build check clean doc new init add run test bench update search publish install uninstall" -s "q" -l "quiet" -d "Do not print cargo log messages"
complete -c cargo -n "not __fish_seen_subcommand_from build check clean doc new init add run test bench update search publish install uninstall" -l "color" -d "Coloring: auto, always, never" -x
complete -c cargo -n "not __fish_seen_subcommand_from build check clean doc new init add run test bench update search publish install uninstall" -l "frozen" -d "Require Cargo.lock and cache are up to date"
complete -c cargo -n "not __fish_seen_subcommand_from build check clean doc new init add run test bench update search publish install uninstall" -l "locked" -d "Require Cargo.lock is up to date"
complete -c cargo -n "not __fish_seen_subcommand_from build check clean doc new init add run test bench update search publish install uninstall" -l "offline" -d "Run without accessing the network"
complete -c cargo -n "not __fish_seen_subcommand_from build check clean doc new init add run test bench update search publish install uninstall" -l "config" -d "Override a configuration value" -x
complete -c cargo -n "not __fish_seen_subcommand_from build check clean doc new init add run test bench update search publish install uninstall" -s "Z" -d "Unstable (nightly-only) flags to Cargo, see 'cargo -Z help' for details" -x
complete -c cargo -n "not __fish_seen_subcommand_from build check clean doc new init add run test bench update search publish install uninstall" -s "h" -l "help" -d "Print help information"
...
complete -k -c cargo -n __fish_use_subcommand -x -a add -d "Add dependencies to a manifest file"
...
complete -c cargo -n "__fish_seen_subcommand_from build" -s "q" -l "quiet" -d "Do not print cargo log messages"
...
complete -c cargo -n "__fish_seen_subcommand_from build" -l "keep-going" -d "Do not abort the build as soon as there is an error (unstable)"
...
complete -c cargo -n "__fish_seen_subcommand_from build" -l "config" -d "Override a configuration value" -x
...
complete -c cargo -n "__fish_seen_subcommand_from build" -s "r" -l "release" -d "Build artifacts in release mode, with optimizations"
complete -c cargo -n "__fish_seen_subcommand_from build" -l "profile" -d "Build artifacts with the specified profile" -r
complete -c cargo -n "__fish_seen_subcommand_from build" -s "F" -l "features" -d "Space or comma separated list of features to activate" -x
...
complete -c cargo -n "__fish_seen_subcommand_from build" -l "ignore-rust-version" -d "Ignore `rust-version` specification in packages"
...
complete -c cargo -n "__fish_seen_subcommand_from build" -l "future-incompat-report" -d "Outputs a future incompatibility report at the end of the build"
complete -c cargo -n "__fish_seen_subcommand_from build" -l "timings" -d "Timing output formats (unstable) (comma separated): html, json" -x
complete -c cargo -n "__fish_seen_subcommand_from build" -s "h" -l "help" -d "Print help information"



complete -c cargo -n "__fish_seen_subcommand_from check" -s "q" -l "quiet" -d "Do not print cargo log messages"
...
complete -c cargo -n "__fish_seen_subcommand_from check" -l "keep-going" -d "Do not abort the build as soon as there is an error (unstable)"
...
complete -c cargo -n "__fish_seen_subcommand_from check" -l "config" -d "Override a configuration value" -x
...
complete -c cargo -n "__fish_seen_subcommand_from check" -s "r" -l "release" -d "Check artifacts in release mode, with optimizations"
complete -c cargo -n "__fish_seen_subcommand_from check" -l "profile" -d "Check artifacts with the specified profile" -r
complete -c cargo -n "__fish_seen_subcommand_from check" -s "F" -l "features" -d "Space or comma separated list of features to activate" -x
...
complete -c cargo -n "__fish_seen_subcommand_from check" -l "ignore-rust-version" -d "Ignore `rust-version` specification in packages"
...
complete -c cargo -n "__fish_seen_subcommand_from check" -l "future-incompat-report" -d "Outputs a future incompatibility report at the end of the build"
complete -c cargo -n "__fish_seen_subcommand_from check" -l "timings" -d "Timing output formats (unstable) (comma separated): html, json" -x
complete -c cargo -n "__fish_seen_subcommand_from check" -s "h" -l "help" -d "Print help information"



complete -c cargo -n "__fish_seen_subcommand_from clean" -s "q" -l "quiet" -d "Do not print cargo log messages"
...
complete -c cargo -n "__fish_seen_subcommand_from clean" -s "r" -l "release" -d "Whether or not to clean release artifacts"
...
complete -c cargo -n "__fish_seen_subcommand_from clean" -l "config" -d "Override a configuration value" -x
...
complete -c cargo -n "__fish_seen_subcommand_from clean" -s "h" -l "help" -d "Print help information"



complete -c cargo -n "__fish_seen_subcommand_from doc" -s "q" -l "quiet" -d "Do not print cargo log messages"
...
complete -c cargo -n "__fish_seen_subcommand_from doc" -l "config" -d "Override a configuration value" -x
complete -c cargo -n "__fish_seen_subcommand_from doc" -l "keep-going" -d "Do not abort the build as soon as there is an error (unstable)"
...
complete -c cargo -n "__fish_seen_subcommand_from doc" -l "example" -d "Document only the specified example" -x
complete -c cargo -n "__fish_seen_subcommand_from doc" -l "examples" -d "Document all examples"
complete -c cargo -n "__fish_seen_subcommand_from doc" -s "r" -l "release" -d "Build artifacts in release mode, with optimizations"
complete -c cargo -n "__fish_seen_subcommand_from doc" -l "profile" -d "Build artifacts with the specified profile" -r
complete -c cargo -n "__fish_seen_subcommand_from doc" -s "F" -l "features" -d "Space or comma separated list of features to activate" -x
...
complete -c cargo -n "__fish_seen_subcommand_from doc" -l "ignore-rust-version" -d "Ignore `rust-version` specification in packages"
complete -c cargo -n "__fish_seen_subcommand_from doc" -l "unit-graph" -d "Output build graph in JSON (unstable)"
complete -c cargo -n "__fish_seen_subcommand_from doc" -l "timings" -d "Timing output formats (unstable) (comma separated): html, json" -x
complete -c cargo -n "__fish_seen_subcommand_from doc" -s "h" -l "help" -d "Print help information"



complete -c cargo -n "__fish_seen_subcommand_from new" -s "q" -l "quiet" -d "Do not print cargo log messages"
...
complete -c cargo -n "__fish_seen_subcommand_from new" -l "config" -d "Override a configuration value" -x
...
complete -c cargo -n "__fish_seen_subcommand_from new" -s "h" -l "help" -d "Print help information"



complete -c cargo -n "__fish_seen_subcommand_from init" -s "q" -l "quiet" -d "Do not print cargo log messages"
...
complete -c cargo -n "__fish_seen_subcommand_from init" -l "config" -d "Override a configuration value" -x
...
complete -c cargo -n "__fish_seen_subcommand_from init" -s "h" -l "help" -d "Print help information"



complete -c cargo -n "__fish_seen_subcommand_from add" -l "no-default-features" -d "Disable the default features"
complete -c cargo -n "__fish_seen_subcommand_from add" -l "default-features" -d "Re-enable the default features"
complete -c cargo -n "__fish_seen_subcommand_from add" -s "F" -l "features" -d "Space or comma separated list of features to activate" -x
complete -c cargo -n "__fish_seen_subcommand_from add" -l "optional" -d "Mark the dependency as optional"
complete -c cargo -n "__fish_seen_subcommand_from add" -s "v" -l "verbose" -d "Use verbose output (-vv very verbose/build.rs output)"
complete -c cargo -n "__fish_seen_subcommand_from add" -l "no-optional" -d "Mark the dependency as required"
complete -c cargo -n "__fish_seen_subcommand_from add" -l "color" -d "Coloring: auto, always, never" -x
complete -c cargo -n "__fish_seen_subcommand_from add" -l "rename" -d "Rename the dependency" -x
complete -c cargo -n "__fish_seen_subcommand_from add" -l "frozen" -d "Require Cargo.lock and cache are up to date"
complete -c cargo -n "__fish_seen_subcommand_from add" -l "manifest-path" -d "Path to Cargo.toml" -r
complete -c cargo -n "__fish_seen_subcommand_from add" -l "locked" -d "Require Cargo.lock is up to date"
complete -c cargo -n "__fish_seen_subcommand_from add" -s "p" -l "package" -d "Package to modify" -x
complete -c cargo -n "__fish_seen_subcommand_from add" -l "offline" -d "Run without accessing the network"
complete -c cargo -n "__fish_seen_subcommand_from add" -s "q" -l "quiet" -d "Do not print cargo log messages"
complete -c cargo -n "__fish_seen_subcommand_from add" -l "config" -d "Override a configuration value" -x
complete -c cargo -n "__fish_seen_subcommand_from add" -l "dry-run" -d "Don't actually write the manifest"
complete -c cargo -n "__fish_seen_subcommand_from add" -s "Z" -d "Unstable (nightly-only) flags to Cargo, see 'cargo -Z help' for details" -x
complete -c cargo -n "__fish_seen_subcommand_from add" -s "h" -l "help" -d "Print help information"
complete -c cargo -n "__fish_seen_subcommand_from add" -l "path" -d "Filesystem path to local crate to add" -r
complete -c cargo -n "__fish_seen_subcommand_from add" -l "git" -d "Git repository location" -x
complete -c cargo -n "__fish_seen_subcommand_from add" -l "branch" -d "Git branch to download the crate from" -x
complete -c cargo -n "__fish_seen_subcommand_from add" -l "tag" -d "Git tag to download the crate from" -x
complete -c cargo -n "__fish_seen_subcommand_from add" -l "rev" -d "Git reference to download the crate from" -x
complete -c cargo -n "__fish_seen_subcommand_from add" -l "registry" -d "Package registry for this dependency" -x
complete -c cargo -n "__fish_seen_subcommand_from add" -l "dev" -d "Add as development dependency"
complete -c cargo -n "__fish_seen_subcommand_from add" -l "build" -d "Add as build dependency"
complete -c cargo -n "__fish_seen_subcommand_from add" -l "target" -d "Add as dependency to the given target platform" -x



complete -c cargo -n "__fish_seen_subcommand_from run" -s "q" -l "quiet" -d "Do not print cargo log messages"
...
complete -c cargo -n "__fish_seen_subcommand_from run" -l "keep-going" -d "Do not abort the build as soon as there is an error (unstable)"
complete -c cargo -n "__fish_seen_subcommand_from run" -l "frozen" -d "Require Cargo.lock and cache are up to date"
complete -c cargo -n "__fish_seen_subcommand_from run" -s "r" -l "release" -d "Build artifacts in release mode, with optimizations"
...
complete -c cargo -n "__fish_seen_subcommand_from run" -s "F" -l "features" -d "Space or comma separated list of features to activate" -x
...
complete -c cargo -n "__fish_seen_subcommand_from run" -l "config" -d "Override a configuration value" -x
...
complete -c cargo -n "__fish_seen_subcommand_from run" -l "ignore-rust-version" -d "Ignore `rust-version` specification in packages"
complete -c cargo -n "__fish_seen_subcommand_from run" -l "timings" -d "Timing output formats (unstable) (comma separated): html, json" -x
complete -c cargo -n "__fish_seen_subcommand_from run" -s "h" -l "help" -d "Print help information"
...
complete -c cargo -n "__fish_seen_subcommand_from test" -l "config" -d "Override a configuration value" -x
...
complete -c cargo -n "__fish_seen_subcommand_from test" -l "keep-going" -d "Do not abort the build as soon as there is an error (unstable)"
complete -c cargo -n "__fish_seen_subcommand_from test" -s "r" -l "release" -d "Build artifacts in release mode, with optimizations"
complete -c cargo -n "__fish_seen_subcommand_from test" -l "profile" -d "Build artifacts with the specified profile" -r
complete -c cargo -n "__fish_seen_subcommand_from test" -s "F" -l "features" -d "Space or comma separated list of features to activate" -x
...
complete -c cargo -n "__fish_seen_subcommand_from test" -l "ignore-rust-version" -d "Ignore `rust-version` specification in packages"
...
complete -c cargo -n "__fish_seen_subcommand_from test" -l "future-incompat-report" -d "Outputs a future incompatibility report at the end of the build"
complete -c cargo -n "__fish_seen_subcommand_from test" -l "timings" -d "Timing output formats (unstable) (comma separated): html, json" -x
complete -c cargo -n "__fish_seen_subcommand_from test" -s "h" -l "help" -d "Print help information"



complete -c cargo -n "__fish_seen_subcommand_from bench" -s "q" -l "quiet" -d "Do not print cargo log messages"
...
complete -c cargo -n "__fish_seen_subcommand_from bench" -l "config" -d "Override a configuration value" -x
...
complete -c cargo -n "__fish_seen_subcommand_from bench" -l "keep-going" -d "Do not abort the build as soon as there is an error (unstable)"
complete -c cargo -n "__fish_seen_subcommand_from bench" -l "profile" -d "Build artifacts with the specified profile" -r
complete -c cargo -n "__fish_seen_subcommand_from bench" -s "F" -l "features" -d "Space or comma separated list of features to activate" -x
...
complete -c cargo -n "__fish_seen_subcommand_from bench" -l "ignore-rust-version" -d "Ignore `rust-version` specification in packages"
...
complete -c cargo -n "__fish_seen_subcommand_from bench" -l "timings" -d "Timing output formats (unstable) (comma separated): html, json" -x
complete -c cargo -n "__fish_seen_subcommand_from bench" -s "h" -l "help" -d "Print help information"



complete -c cargo -n "__fish_seen_subcommand_from update" -s "q" -l "quiet" -d "Do not print cargo log messages"
...
complete -c cargo -n "__fish_seen_subcommand_from update" -l "config" -d "Override a configuration value" -x
...
complete -c cargo -n "__fish_seen_subcommand_from update" -s "h" -l "help" -d "Print help information"



complete -c cargo -n "__fish_seen_subcommand_from search" -s "q" -l "quiet" -d "Do not print cargo log messages"
...
complete -c cargo -n "__fish_seen_subcommand_from search" -l "config" -d "Override a configuration value" -x
...
complete -c cargo -n "__fish_seen_subcommand_from search" -s "h" -l "help" -d "Print help information"



complete -c cargo -n "__fish_seen_subcommand_from publish" -s "q" -l "quiet" -d "Do not print cargo log messages"
...
complete -c cargo -n "__fish_seen_subcommand_from publish" -s "p" -l "package" -d "Package to publish" -x
...
complete -c cargo -n "__fish_seen_subcommand_from publish" -l "config" -d "Override a configuration value" -x
complete -c cargo -n "__fish_seen_subcommand_from publish" -s "F" -l "features" -d "Space or comma separated list of features to activate" -x
...
complete -c cargo -n "__fish_seen_subcommand_from publish" -l "keep-going" -d "Do not abort the build as soon as there is an error (unstable)"
...
complete -c cargo -n "__fish_seen_subcommand_from publish" -s "h" -l "help" -d "Print help information"



complete -c cargo -n "__fish_seen_subcommand_from install" -s "q" -l "quiet" -d "Do not print cargo log messages"
...
complete -c cargo -n "__fish_seen_subcommand_from install" -l "config" -d "Override a configuration value" -x
complete -c cargo -n "__fish_seen_subcommand_from install" -l "keep-going" -d "Do not abort the build as soon as there is an error (unstable)"
...
complete -c cargo -n "__fish_seen_subcommand_from install" -s "F" -l "features" -d "Space or comma separated list of features to activate" -x
...
complete -c cargo -n "__fish_seen_subcommand_from install" -l "debug" -d "Build in debug mode (with the 'dev' profile) instead of release mode"
...
complete -c cargo -n "__fish_seen_subcommand_from install" -l "message-format" -d "Error format" -x
complete -c cargo -n "__fish_seen_subcommand_from install" -l "timings" -d "Timing output formats (unstable) (comma separated): html, json" -x
complete -c cargo -n "__fish_seen_subcommand_from install" -s "h" -l "help" -d "Print help information"



complete -c cargo -n "__fish_seen_subcommand_from uninstall" -s "q" -l "quiet" -d "Do not print cargo log messages"
...
complete -c cargo -n "__fish_seen_subcommand_from uninstall" -l "config" -d "Override a configuration value" -x
...
complete -c cargo -n "__fish_seen_subcommand_from uninstall" -s "h" -l "help" -d "Print help information"
