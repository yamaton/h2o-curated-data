...
complete -c chgrp -l "reference" -d "use RFILE's group rather than specifying a GROUP value" -r
...
complete -c chgrp -l "version" -d "output version information and exit"
