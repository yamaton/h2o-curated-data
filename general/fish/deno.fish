...
complete -c deno -n "not __fish_seen_subcommand_from bench bundle cache check compile completions coverage doc eval fmt info install lint lsp repl run task test types uninstall upgrade vendor" -s "h" -l "help" -d "Print help information"
complete -c deno -n "not __fish_seen_subcommand_from bench bundle cache check compile completions coverage doc eval fmt info install lint lsp repl run task test types uninstall upgrade vendor" -s "q" -l "quiet" -d "Suppress diagnostic output"
complete -c deno -n "not __fish_seen_subcommand_from bench bundle cache check compile completions coverage doc eval fmt info install lint lsp repl run task test types uninstall upgrade vendor" -l "unstable" -d "Enable unstable features and APIs"
complete -c deno -n "not __fish_seen_subcommand_from bench bundle cache check compile completions coverage doc eval fmt info install lint lsp repl run task test types uninstall upgrade vendor" -s "V" -l "version" -d "Print version information"
...
complete -c deno -n "__fish_seen_subcommand_from compile" -l "compat" -d "See https://deno.land/manual@v1.22.0/node/compatibility_mode"
...
complete -c deno -n "__fish_seen_subcommand_from eval" -l "compat" -d "See https://deno.land/manual@v1.22.0/node/compatibility_mode"
...
complete -c deno -n "__fish_seen_subcommand_from install" -l "compat" -d "See https://deno.land/manual@v1.22.0/node/compatibility_mode"
...
complete -c deno -n "__fish_seen_subcommand_from repl" -l "compat" -d "See https://deno.land/manual@v1.22.0/node/compatibility_mode"
...
complete -c deno -n "__fish_seen_subcommand_from run" -l "compat" -d "See https://deno.land/manual@v1.22.0/node/compatibility_mode"
...
complete -c deno -n "__fish_seen_subcommand_from test" -l "compat" -d "See https://deno.land/manual@v1.22.0/node/compatibility_mode"
