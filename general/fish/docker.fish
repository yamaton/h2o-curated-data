...
complete -k -c docker -n __fish_use_subcommand -x -a scout -d "Command line tool for Docker Scout (Docker Inc., 0.16.1)"
complete -k -c docker -n __fish_use_subcommand -x -a scan -d "Docker Scan (Docker Inc., v0.26.0)"
...
complete -k -c docker -n __fish_use_subcommand -x -a init -d "Creates Docker-related starter files for your project (Docker Inc., v0.1.0-beta.6)"
complete -k -c docker -n __fish_use_subcommand -x -a image -d "Manage images"
complete -k -c docker -n __fish_use_subcommand -x -a extension -d "Manages Docker extensions (Docker Inc., v0.2.20)"
complete -k -c docker -n __fish_use_subcommand -x -a dev -d "Docker Dev Environments (Docker Inc., v0.1.0)"
...
complete -k -c docker -n __fish_use_subcommand -x -a compose -d "Docker Compose (Docker Inc., v2.19.1)"
complete -k -c docker -n __fish_use_subcommand -x -a buildx -d "Docker Buildx (Docker Inc., v0.11.0)"
...
complete -k -c docker -n __fish_use_subcommand -x -a search -d "Search Docker Hub for images"
complete -k -c docker -n __fish_use_subcommand -x -a logout -d "Log out from a registry"
complete -k -c docker -n __fish_use_subcommand -x -a login -d "Log in to a registry"
complete -k -c docker -n __fish_use_subcommand -x -a images -d "List images"
complete -k -c docker -n __fish_use_subcommand -x -a push -d "Upload an image to a registry"
complete -k -c docker -n __fish_use_subcommand -x -a pull -d "Download an image from a registry"
...
complete -k -c docker -n __fish_use_subcommand -x -a exec -d "Execute a command in a running container"
complete -k -c docker -n __fish_use_subcommand -x -a run -d "Create and run a new container from an image"



complete -c docker -n "__fish_seen_subcommand_from run" -l "add-host" -d "Add a custom host-to-IP mapping (host:ip)" -x
complete -c docker -n "__fish_seen_subcommand_from run" -l "annotation" -d "Add an annotation to the container (passed through to the OCI runtime) (default map[])" -x
...
complete -c docker -n "__fish_seen_subcommand_from run" -s "q" -l "quiet" -d "Suppress the pull output"
...
complete -c docker -n "__fish_seen_subcommand_from run" -l "stop-signal" -d "Signal to stop the container" -x
...
complete -c docker -n "__fish_seen_subcommand_from ps" -l "format" -d "Format output using a custom template: 'table': Print output in table format with column headers (default) 'table TEMPLATE': Print output in table format using the given Go template 'json': Print in JSON format 'TEMPLATE': Print output using the given Go template." -x
...
complete -c docker -n "__fish_seen_subcommand_from build" -l "add-host" -d "Add a custom host-to-IP mapping (format: \"host:ip\")" -x
complete -c docker -n "__fish_seen_subcommand_from build" -l "allow" -d "Allow extra privileged entitlement (e.g., \"network.host\", \"security.insecure\")" -x
complete -c docker -n "__fish_seen_subcommand_from build" -l "attest" -d "Attestation parameters (format: \"type=sbom,generator=image\")" -x
complete -c docker -n "__fish_seen_subcommand_from build" -l "build-arg" -d "Set build-time variables" -x
complete -c docker -n "__fish_seen_subcommand_from build" -l "build-context" -d "Additional build contexts (e.g., name=path)" -r
complete -c docker -n "__fish_seen_subcommand_from build" -l "builder" -d "Override the configured builder instance (default \"default\")" -x
complete -c docker -n "__fish_seen_subcommand_from build" -l "cache-from" -d "External cache sources (e.g., \"user/app:cache\", \"type=local,src=path/to/dir\")" -r
complete -c docker -n "__fish_seen_subcommand_from build" -l "cache-to" -d "Cache export destinations (e.g., \"user/app:cache\", \"type=local,dest=path/to/dir\")" -r
complete -c docker -n "__fish_seen_subcommand_from build" -l "cgroup-parent" -d "Optional parent cgroup for the container" -x
complete -c docker -n "__fish_seen_subcommand_from build" -s "f" -l "file" -d "Name of the Dockerfile (default: \"PATH/Dockerfile\")" -r
...
complete -c docker -n "__fish_seen_subcommand_from build" -l "load" -d "Shorthand for \"--output=type=docker\""
complete -c docker -n "__fish_seen_subcommand_from build" -l "metadata-file" -d "Write build result metadata to the file" -r
...
complete -c docker -n "__fish_seen_subcommand_from build" -l "no-cache-filter" -d "Do not cache specified stages" -x
complete -c docker -n "__fish_seen_subcommand_from build" -s "o" -l "output" -d "Output destination (format: \"type=local,dest=path\")" -r
complete -c docker -n "__fish_seen_subcommand_from build" -l "platform" -d "Set target platform for build" -x
complete -c docker -n "__fish_seen_subcommand_from build" -l "progress" -d "Set type of progress output (\"auto\", \"plain\", \"tty\")." -x
complete -c docker -n "__fish_seen_subcommand_from build" -l "provenance" -d "Shorthand for \"--attest=type=provenance\"" -x
complete -c docker -n "__fish_seen_subcommand_from build" -l "pull" -d "Always attempt to pull all referenced images"
complete -c docker -n "__fish_seen_subcommand_from build" -l "push" -d "Shorthand for \"--output=type=registry\""
...
complete -c docker -n "__fish_seen_subcommand_from build" -l "sbom" -d "Shorthand for \"--attest=type=sbom\"" -x
complete -c docker -n "__fish_seen_subcommand_from build" -l "secret" -d "Secret to expose to the build (format: \"id=mysecret[,src=/local/secret]\")" -x
complete -c docker -n "__fish_seen_subcommand_from build" -l "shm-size" -d "Size of \"/dev/shm\"" -x
complete -c docker -n "__fish_seen_subcommand_from build" -l "ssh" -d "SSH agent socket or keys to expose to the build (format: \"default|<id>[=<socket>|<key>[,<key>]]\")" -x
complete -c docker -n "__fish_seen_subcommand_from build" -s "t" -l "tag" -d "Name and optionally a tag (format: \"name:tag\")" -x
...
complete -c docker -n "__fish_seen_subcommand_from push" -s "a" -l "all-tags" -d "Push all tags of an image to the repository"
...
complete -c docker -n "__fish_seen_subcommand_from images" -l "format" -d "Format output using a custom template: 'table': Print output in table format with column headers (default) 'table TEMPLATE': Print output in table format using the given Go template 'json': Print in JSON format 'TEMPLATE': Print output using the given Go template." -x
...
complete -c docker -n "__fish_seen_subcommand_from search" -l "limit" -d "Max number of search results" -x
...
complete -c docker -n "__fish_seen_subcommand_from info" -s "f" -l "format" -d "Format output using a custom template: 'json': Print in JSON format 'TEMPLATE': Print output using the given Go template." -x
...
complete -c docker -n "__fish_seen_subcommand_from cp" -s "q" -l "quiet" -d "Suppress progress output during copy."



complete -c docker -n "__fish_seen_subcommand_from create" -l "add-host" -d "Add a custom host-to-IP mapping (host:ip)" -x
complete -c docker -n "__fish_seen_subcommand_from create" -l "annotation" -d "Add an annotation to the container (passed through to the OCI runtime) (default map[])" -x
...
complete -c docker -n "__fish_seen_subcommand_from create" -s "q" -l "quiet" -d "Suppress the pull output"
...
complete -c docker -n "__fish_seen_subcommand_from create" -l "stop-signal" -d "Signal to stop the container" -x
...
complete -c docker -n "__fish_seen_subcommand_from history" -l "format" -d "Format output using a custom template: 'table': Print output in table format with column headers (default) 'table TEMPLATE': Print output in table format using the given Go template 'json': Print in JSON format 'TEMPLATE': Print output using the given Go template." -x
...
complete -c docker -n "__fish_seen_subcommand_from inspect" -s "f" -l "format" -d "Format output using a custom template: 'json': Print in JSON format 'TEMPLATE': Print output using the given Go template." -x
...
complete -c docker -n "__fish_seen_subcommand_from kill" -s "s" -l "signal" -d "Signal to send to the container" -x
...
complete -c docker -n "__fish_seen_subcommand_from restart" -s "s" -l "signal" -d "Signal to send to the container" -x
complete -c docker -n "__fish_seen_subcommand_from restart" -s "t" -l "time" -d "Seconds to wait before killing the container" -x
...
complete -c docker -n "__fish_seen_subcommand_from stats" -l "format" -d "Format output using a custom template: 'table': Print output in table format with column headers (default) 'table TEMPLATE': Print output in table format using the given Go template 'json': Print in JSON format 'TEMPLATE': Print output using the given Go template." -x
...
complete -c docker -n "__fish_seen_subcommand_from stop" -s "s" -l "signal" -d "Signal to send to the container" -x
complete -c docker -n "__fish_seen_subcommand_from stop" -s "t" -l "time" -d "Seconds to wait before killing the container" -x
...
complete -c docker -n "__fish_seen_subcommand_from builder" -l "builder" -d "Override the configured builder instance (default \"default\")" -x
...
complete -c docker -n "__fish_seen_subcommand_from compose" -l "dry-run" -d "Execute command in dry run mode"
...
complete -c docker -n "__fish_seen_subcommand_from compose" -l "parallel" -d "Control max parallelism, -1 for unlimited (default -1)" -x
complete -c docker -n "__fish_seen_subcommand_from compose" -l "profile" -d "Specify a profile to enable" -r
complete -c docker -n "__fish_seen_subcommand_from compose" -l "progress" -d "Set type of progress output (auto, tty, plain, quiet) (default \"auto\")" -x
...
complete -c docker -n "__fish_seen_subcommand_from dev" -s "s" -l "socket" -d "Sets the path to the unix socket or pipe to be targeted." -r
complete -c docker -n "__fish_seen_subcommand_from dev" -s "v" -l "version" -d "Display version of the dev plugin"
...
complete -c docker -n "__fish_seen_subcommand_from init" -l "version" -d "Display version of the init plugin"
