...
complete -c ghcup -n "not __fish_seen_subcommand_from tui install set unset rm list upgrade compile whereis prefetch gc run debug-info tool-requirements changelog config nuke" -l keep -d 'Keep build directories? (default: errors)' -x
