...
complete -k -c kubectl -n __fish_use_subcommand -x -a plugin -d "Provides utilities for interacting with plugins"
...
complete -k -c kubectl -n __fish_use_subcommand -x -a events -d "List events"
...
complete -k -c kubectl -n __fish_use_subcommand -x -a auth -d "Inspect authorization"
...
complete -k -c kubectl -n __fish_use_subcommand -x -a port-forward -d "Forward one or more local ports to a pod"
...
complete -k -c kubectl -n __fish_use_subcommand -x -a cluster-info -d "Display cluster information"
complete -k -c kubectl -n __fish_use_subcommand -x -a certificate -d "Modify certificate resources."
...
complete -c kubectl -n "__fish_seen_subcommand_from create" -l "allow-missing-template-keys" -d "If true, ignore any errors in templates when a field or map key is missing in the template." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from expose" -l "allow-missing-template-keys" -d "If true, ignore any errors in templates when a field or map key is missing in the template." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from expose" -s "o" -l "output" -d "Output format." -r
complete -c kubectl -n "__fish_seen_subcommand_from expose" -l "override-type" -d "The method used to override the generated object: json, merge, or strategic." -x
...
complete -c kubectl -n "__fish_seen_subcommand_from expose" -s "R" -l "recursive" -d "Process the directory used in -f, --filename recursively." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from expose" -l "target-port" -d "Name or number for the port on the container that the service should direct traffic to." -r
complete -c kubectl -n "__fish_seen_subcommand_from expose" -l "template" -d "Template string or path to template file to use when -o=go-template, -o=go-template-file." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from run" -s "l" -l "labels" -d "Comma separated labels to apply to the pod." -x
...
complete -c kubectl -n "__fish_seen_subcommand_from run" -s "o" -l "output" -d "Output format." -r
complete -c kubectl -n "__fish_seen_subcommand_from run" -l "override-type" -d "The method used to override the generated object: json, merge, or strategic." -x
...
complete -c kubectl -n "__fish_seen_subcommand_from run" -l "rm" -d "If true, delete the pod after it exits." -x
...
complete -c kubectl -n "__fish_seen_subcommand_from run" -s "i" -l "stdin" -d "Keep stdin open on the container in the pod, even if nothing is attached." -x
complete -c kubectl -n "__fish_seen_subcommand_from run" -l "template" -d "Template string or path to template file to use when -o=go-template, -o=go-template-file." -r
complete -c kubectl -n "__fish_seen_subcommand_from run" -s "t" -l "tty" -d "Allocate a TTY for the container in the pod." -x
...
complete -c kubectl -n "__fish_seen_subcommand_from explain" -l "output" -d "Format in which to render the schema (plaintext, plaintext-openapiv2)" -x
...
complete -c kubectl -n "__fish_seen_subcommand_from delete" -l "all" -d "Delete all resources, in the namespace of the specified resource types." -x
...
complete -c kubectl -n "__fish_seen_subcommand_from delete" -s "k" -l "kustomize" -d "Process a kustomization directory." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from autoscale" -l "allow-missing-template-keys" -d "If true, ignore any errors in templates when a field or map key is missing in the template." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from autoscale" -s "o" -l "output" -d "Output format." -r
complete -c kubectl -n "__fish_seen_subcommand_from autoscale" -s "R" -l "recursive" -d "Process the directory used in -f, --filename recursively." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from autoscale" -l "template" -d "Template string or path to template file to use when -o=go-template, -o=go-template-file." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from taint" -l "allow-missing-template-keys" -d "If true, ignore any errors in templates when a field or map key is missing in the template." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from proxy" -l "accept-paths" -d "Regular expression for paths that the proxy should accept." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from proxy" -l "append-server-path" -d "If true, enables automatic path appending of the kube context server path to each request." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from proxy" -l "reject-paths" -d "Regular expression for paths that the proxy should reject." -r
complete -c kubectl -n "__fish_seen_subcommand_from proxy" -s "u" -l "unix-socket" -d "Unix socket on which to run the proxy." -x
complete -c kubectl -n "__fish_seen_subcommand_from proxy" -s "w" -l "www" -d "Also serve static files from the given directory under the specified prefix." -r
complete -c kubectl -n "__fish_seen_subcommand_from proxy" -s "P" -l "www-prefix" -d "Prefix to serve static files under, if static file directory is specified." -r



complete -c kubectl -n "__fish_seen_subcommand_from cp" -s "c" -l "container" -d "Container name." -x
complete -c kubectl -n "__fish_seen_subcommand_from cp" -l "no-preserve" -d "The copied file/directory's ownership and permissions will not be preserved in the container" -r
complete -c kubectl -n "__fish_seen_subcommand_from cp" -l "retries" -d "Set number of retries to complete a copy operation from a container." -x
...
complete -c kubectl -n "__fish_seen_subcommand_from debug" -s "f" -l "filename" -d "identifying the resource to debug" -x
...
complete -c kubectl -n "__fish_seen_subcommand_from debug" -l "profile" -d "Debugging profile." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from events" -s "A" -l "all-namespaces" -d "If present, list the requested object(s) across all namespaces." -x
complete -c kubectl -n "__fish_seen_subcommand_from events" -l "allow-missing-template-keys" -d "If true, ignore any errors in templates when a field or map key is missing in the template." -r
complete -c kubectl -n "__fish_seen_subcommand_from events" -l "chunk-size" -d "Return large lists in chunks rather than all at once." -x
complete -c kubectl -n "__fish_seen_subcommand_from events" -l "for" -d "Filter events to only those pertaining to the specified resource." -x
complete -c kubectl -n "__fish_seen_subcommand_from events" -l "no-headers" -d "When using the default output format, don't print headers." -x
complete -c kubectl -n "__fish_seen_subcommand_from events" -s "o" -l "output" -d "Output format." -r
complete -c kubectl -n "__fish_seen_subcommand_from events" -l "show-managed-fields" -d "If true, keep the managedFields when printing objects in JSON or YAML format." -x
complete -c kubectl -n "__fish_seen_subcommand_from events" -l "template" -d "Template string or path to template file to use when -o=go-template, -o=go-template-file." -r
complete -c kubectl -n "__fish_seen_subcommand_from events" -l "types" -d "Output only events of given types." -x
complete -c kubectl -n "__fish_seen_subcommand_from events" -s "w" -l "watch" -d "After listing the requested events, watch for more events." -x
...
complete -c kubectl -n "__fish_seen_subcommand_from apply" -l "allow-missing-template-keys" -d "If true, ignore any errors in templates when a field or map key is missing in the template." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from apply" -s "k" -l "kustomize" -d "Process a kustomization directory." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from apply" -l "prune-allowlist" -d "Overwrite the default allowlist with <group/version/kind> for --prune" -x
...
complete -c kubectl -n "__fish_seen_subcommand_from patch" -s "p" -l "patch" -d "The patch to be applied to the resource JSON file." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from replace" -l "allow-missing-template-keys" -d "If true, ignore any errors in templates when a field or map key is missing in the template." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from replace" -s "o" -l "output" -d "Output format." -r
complete -c kubectl -n "__fish_seen_subcommand_from replace" -l "raw" -d "Raw URI to PUT to the server." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from wait" -l "template" -d "Template string or path to template file to use when -o=go-template, -o=go-template-file." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from label" -l "all" -d "Select all resources, in the namespace of the specified resource types" -x
...
complete -c kubectl -n "__fish_seen_subcommand_from label" -l "allow-missing-template-keys" -d "If true, ignore any errors in templates when a field or map key is missing in the template." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from label" -s "o" -l "output" -d "Output format." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from label" -s "R" -l "recursive" -d "Process the directory used in -f, --filename recursively." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from label" -s "l" -l "selector" -d "Selector (label query) to filter on, supports '=', '==', and '!='.(e.g. -l key1=value1,key2=value2)." -x
...
complete -c kubectl -n "__fish_seen_subcommand_from label" -l "template" -d "Template string or path to template file to use when -o=go-template, -o=go-template-file." -r



complete -c kubectl -n "__fish_seen_subcommand_from annotate" -l "all" -d "Select all resources, in the namespace of the specified resource types." -x
...
complete -c kubectl -n "__fish_seen_subcommand_from annotate" -l "allow-missing-template-keys" -d "If true, ignore any errors in templates when a field or map key is missing in the template." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from annotate" -s "o" -l "output" -d "Output format." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from annotate" -s "R" -l "recursive" -d "Process the directory used in -f, --filename recursively." -r
...
complete -c kubectl -n "__fish_seen_subcommand_from annotate" -s "l" -l "selector" -d "Selector (label query) to filter on, supports '=', '==', and '!='.(e.g. -l key1=value1,key2=value2)." -x
...
complete -c kubectl -n "__fish_seen_subcommand_from annotate" -l "template" -d "Template string or path to template file to use when -o=go-template, -o=go-template-file." -r



complete -c kubectl -n "__fish_seen_subcommand_from api-resources" -l "api-group" -d "Limit to resources in the specified API group." -x
complete -c kubectl -n "__fish_seen_subcommand_from api-resources" -l "cached" -d "Use the cached list of resources if available." -x
complete -c kubectl -n "__fish_seen_subcommand_from api-resources" -l "categories" -d "Limit to resources that belong the the specified categories." -x
complete -c kubectl -n "__fish_seen_subcommand_from api-resources" -l "namespaced" -d "If false, non-namespaced resources will be returned, otherwise returning namespaced resources by default." -x
