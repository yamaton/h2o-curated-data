...
complete -c oc -n "__fish_seen_subcommand_from login" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
...
complete -c oc -n "__fish_seen_subcommand_from login" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from login" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from login" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from login" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from login" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from login" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from login" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from login" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from login" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from login" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from login" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from login" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from login" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from login" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from login" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from login" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from new-project" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from new-project" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from new-project" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from new-project" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from new-project" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from new-project" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from new-project" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from new-project" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from new-project" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from new-project" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from new-project" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from new-project" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from new-project" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from new-project" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from new-project" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from new-project" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from new-app" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from new-app" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from new-app" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from new-app" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from new-app" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from new-app" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from new-app" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from new-app" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from new-app" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from new-app" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from new-app" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from new-app" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from new-app" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from new-app" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from new-app" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from new-app" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from new-app" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from status" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from status" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from status" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from status" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from status" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from status" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from status" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from status" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from status" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from status" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from status" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from status" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from status" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from status" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from status" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from status" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from status" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from project" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from project" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from project" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from project" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from project" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from project" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from project" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from project" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from project" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from project" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from project" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from project" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from project" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from project" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from project" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from project" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from project" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from projects" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from projects" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from projects" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from projects" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from projects" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from projects" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from projects" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from projects" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from projects" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from projects" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from projects" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from projects" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from projects" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from projects" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from projects" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from projects" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from explain" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from explain" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from explain" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from explain" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from explain" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from explain" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from explain" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from explain" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from explain" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from explain" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from explain" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from explain" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from explain" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from explain" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from explain" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from explain" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from explain" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from rollout" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from rollout" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from rollout" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from rollout" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from rollout" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from rollout" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from rollout" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from rollout" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from rollout" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from rollout" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from rollout" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from rollout" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from rollout" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from rollout" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from rollout" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from rollout" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from rollout" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from rollback" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from rollback" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from rollback" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from rollback" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from rollback" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from rollback" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from rollback" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from rollback" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from rollback" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from rollback" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from rollback" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from rollback" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from rollback" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from rollback" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from rollback" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from rollback" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from new-build" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from new-build" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from new-build" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from new-build" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from new-build" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from new-build" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from new-build" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from new-build" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from new-build" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from new-build" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from new-build" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from new-build" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from new-build" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from new-build" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from new-build" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from new-build" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from start-build" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from start-build" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from start-build" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from start-build" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from start-build" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from start-build" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from start-build" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from start-build" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from start-build" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from start-build" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from start-build" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from start-build" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from start-build" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from start-build" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from start-build" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from start-build" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from cancel-build" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from cancel-build" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from cancel-build" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from cancel-build" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from cancel-build" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from cancel-build" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from cancel-build" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from cancel-build" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from cancel-build" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from cancel-build" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from cancel-build" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from cancel-build" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from cancel-build" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from cancel-build" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from cancel-build" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from cancel-build" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from import-image" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from import-image" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from import-image" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from import-image" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from import-image" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from import-image" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from import-image" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from import-image" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from import-image" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from import-image" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from import-image" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from import-image" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from import-image" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from import-image" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from import-image" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from import-image" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from tag" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from tag" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from tag" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from tag" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from tag" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from tag" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from tag" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from tag" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from tag" -l log-flush-frequency -d 'Maximum number of seconds between log flushes' -x
complete -c oc -n "__fish_seen_subcommand_from tag" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from tag" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from tag" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from tag" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from tag" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from tag" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from tag" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from tag" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from tag" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from create" -s k -l kustomize -d 'Process the kustomization directory.' -x
...
complete -c oc -n "__fish_seen_subcommand_from create" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from create" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from create" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from create" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from create" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from create" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from create" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from create" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from create" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from create" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from create" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from create" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from create" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from create" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from create" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from create" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from create" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from apply" -s k -l kustomize -d 'Process a kustomization directory.' -x
...
complete -c oc -n "__fish_seen_subcommand_from apply" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from apply" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from apply" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from apply" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from apply" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from apply" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from apply" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from apply" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from apply" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from apply" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from apply" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from apply" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from apply" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from apply" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from apply" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from apply" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from apply" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from get" -s k -l kustomize -d 'Process the kustomization directory.' -x
...
complete -c oc -n "__fish_seen_subcommand_from get" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from get" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from get" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from get" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from get" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from get" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from get" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from get" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from get" -l log-flush-frequency -d 'Maximum number of seconds between log flushes' -x
complete -c oc -n "__fish_seen_subcommand_from get" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from get" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from get" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from get" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from get" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from get" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from get" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from get" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from get" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from describe" -s k -l kustomize -d 'Process the kustomization directory.' -x
...
complete -c oc -n "__fish_seen_subcommand_from describe" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from describe" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from describe" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from describe" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from describe" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from describe" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from describe" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from describe" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from describe" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from describe" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from describe" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from describe" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from describe" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from describe" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from describe" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from describe" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from edit" -s k -l kustomize -d 'Process the kustomization directory.' -x
...
complete -c oc -n "__fish_seen_subcommand_from edit" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from edit" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from edit" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from edit" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from edit" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from edit" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from edit" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from edit" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from edit" -l log-flush-frequency -d 'Maximum number of seconds between log flushes' -x
complete -c oc -n "__fish_seen_subcommand_from edit" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from edit" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from edit" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from edit" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from edit" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from edit" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from edit" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from edit" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from edit" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from set" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from set" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from set" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from set" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from set" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from set" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from set" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from set" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from set" -l log-flush-frequency -d 'Maximum number of seconds between log flushes' -x
complete -c oc -n "__fish_seen_subcommand_from set" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from set" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from set" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from set" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from set" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from set" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from set" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from set" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from set" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from label" -s k -l kustomize -d 'Process the kustomization directory.' -x
...
complete -c oc -n "__fish_seen_subcommand_from label" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from label" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from label" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from label" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from label" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from label" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from label" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from label" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from label" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from label" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from label" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from label" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from label" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from label" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from label" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from label" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from label" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from annotate" -s k -l kustomize -d 'Process the kustomization directory.' -x
...
complete -c oc -n "__fish_seen_subcommand_from annotate" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from annotate" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from annotate" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from annotate" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from annotate" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from annotate" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from annotate" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from annotate" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from annotate" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from annotate" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from annotate" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from annotate" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from annotate" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from annotate" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from annotate" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from annotate" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from expose" -s k -l kustomize -d 'Process the kustomization directory.' -x
...
complete -c oc -n "__fish_seen_subcommand_from expose" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from expose" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from expose" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from expose" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from expose" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from expose" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from expose" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from expose" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from expose" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from expose" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from expose" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from expose" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from expose" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from expose" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from expose" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from expose" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from expose" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from delete" -s k -l kustomize -d 'Process a kustomization directory.' -x
...
complete -c oc -n "__fish_seen_subcommand_from delete" -l raw -d 'Raw URI to DELETE to the server.' -x
...
complete -c oc -n "__fish_seen_subcommand_from delete" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from delete" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from delete" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from delete" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from delete" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from delete" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from delete" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from delete" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from delete" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from delete" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from delete" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from delete" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from delete" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from delete" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from delete" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from delete" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from delete" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from scale" -s k -l kustomize -d 'Process the kustomization directory.' -x
...
complete -c oc -n "__fish_seen_subcommand_from scale" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from scale" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from scale" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from scale" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from scale" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from scale" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from scale" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from scale" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from scale" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from scale" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from scale" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from scale" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from scale" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from scale" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from scale" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from scale" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from scale" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from autoscale" -s k -l kustomize -d 'Process the kustomization directory.' -x
...
complete -c oc -n "__fish_seen_subcommand_from autoscale" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from autoscale" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from autoscale" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from autoscale" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from autoscale" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from autoscale" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from autoscale" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from autoscale" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from autoscale" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from autoscale" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from autoscale" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from autoscale" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from autoscale" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from autoscale" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from autoscale" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from autoscale" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from logs" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from logs" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from logs" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from logs" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from logs" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from logs" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from logs" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from logs" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from logs" -l log-flush-frequency -d 'Maximum number of seconds between log flushes' -x
complete -c oc -n "__fish_seen_subcommand_from logs" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from logs" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from logs" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from logs" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from logs" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from logs" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from logs" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from logs" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from logs" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from rsh" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from rsh" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from rsh" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from rsh" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from rsh" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from rsh" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from rsh" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from rsh" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from rsh" -l log-flush-frequency -d 'Maximum number of seconds between log flushes' -x
complete -c oc -n "__fish_seen_subcommand_from rsh" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from rsh" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from rsh" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from rsh" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from rsh" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from rsh" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from rsh" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from rsh" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from rsh" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from rsync" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from rsync" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from rsync" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from rsync" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from rsync" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from rsync" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from rsync" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from rsync" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from rsync" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from rsync" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from rsync" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from rsync" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from rsync" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from rsync" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from rsync" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from rsync" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from rsync" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from port-forward" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from port-forward" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from port-forward" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from port-forward" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from port-forward" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from port-forward" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from port-forward" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from port-forward" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from port-forward" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from port-forward" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from port-forward" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from port-forward" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from port-forward" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from port-forward" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from port-forward" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from port-forward" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from debug" -s k -l kustomize -d 'Process the kustomization directory.' -x
...
complete -c oc -n "__fish_seen_subcommand_from debug" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from debug" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from debug" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from debug" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from debug" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from debug" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from debug" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from debug" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from debug" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from debug" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from debug" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from debug" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from debug" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from debug" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from debug" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from debug" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from debug" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from exec" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from exec" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from exec" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from exec" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from exec" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from exec" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from exec" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from exec" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from exec" -l log-flush-frequency -d 'Maximum number of seconds between log flushes' -x
complete -c oc -n "__fish_seen_subcommand_from exec" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from exec" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from exec" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from exec" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from exec" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from exec" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from exec" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from exec" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from exec" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from proxy" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from proxy" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from proxy" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from proxy" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from proxy" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from proxy" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from proxy" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from proxy" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from proxy" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from proxy" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from proxy" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from proxy" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from proxy" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from proxy" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from proxy" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from proxy" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from proxy" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from attach" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from attach" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from attach" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from attach" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from attach" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from attach" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from attach" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from attach" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from attach" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from attach" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from attach" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from attach" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from attach" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from attach" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from attach" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from attach" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from attach" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from run" -s k -l kustomize -d 'Process a kustomization directory.' -x
...
complete -c oc -n "__fish_seen_subcommand_from run" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from run" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from run" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from run" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from run" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from run" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from run" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from run" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from run" -l log-flush-frequency -d 'Maximum number of seconds between log flushes' -x
complete -c oc -n "__fish_seen_subcommand_from run" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from run" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from run" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from run" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from run" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from run" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from run" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from run" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from run" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from cp" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from cp" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from cp" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from cp" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from cp" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from cp" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from cp" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from cp" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from cp" -l log-flush-frequency -d 'Maximum number of seconds between log flushes' -x
complete -c oc -n "__fish_seen_subcommand_from cp" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from cp" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from cp" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from cp" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from cp" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from cp" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from cp" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from cp" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from cp" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from wait" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from wait" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from wait" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from wait" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from wait" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from wait" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from wait" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from wait" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from wait" -l log-flush-frequency -d 'Maximum number of seconds between log flushes' -x
complete -c oc -n "__fish_seen_subcommand_from wait" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from wait" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from wait" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from wait" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from wait" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from wait" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from wait" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from wait" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from wait" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from adm" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from adm" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from adm" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from adm" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from adm" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from adm" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from adm" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from adm" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from adm" -l log-flush-frequency -d 'Maximum number of seconds between log flushes' -x
complete -c oc -n "__fish_seen_subcommand_from adm" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from adm" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from adm" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from adm" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from adm" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from adm" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from adm" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from adm" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from adm" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from replace" -s k -l kustomize -d 'Process a kustomization directory.' -x
complete -c oc -n "__fish_seen_subcommand_from replace" -s o -l output -d 'Output format.' -x
complete -c oc -n "__fish_seen_subcommand_from replace" -l raw -d 'Raw URI to PUT to the server.' -x
...
complete -c oc -n "__fish_seen_subcommand_from replace" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from replace" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from replace" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from replace" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from replace" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from replace" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from replace" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from replace" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from replace" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from replace" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from replace" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from replace" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from replace" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from replace" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from replace" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from replace" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from replace" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from patch" -s k -l kustomize -d 'Process the kustomization directory.' -x
...
complete -c oc -n "__fish_seen_subcommand_from patch" -l patch-file -d 'A file containing a patch to be applied to the resource.' -x
...
complete -c oc -n "__fish_seen_subcommand_from patch" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from patch" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from patch" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from patch" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from patch" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from patch" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from patch" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from patch" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from patch" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from patch" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from patch" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from patch" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from patch" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from patch" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from patch" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from patch" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from patch" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from process" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from process" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from process" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from process" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from process" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from process" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from process" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from process" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from process" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from process" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from process" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from process" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from process" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from process" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from process" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from process" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from process" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from extract" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from extract" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from extract" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from extract" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from extract" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from extract" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from extract" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from extract" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from extract" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from extract" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from extract" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from extract" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from extract" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from extract" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from extract" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from extract" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from extract" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from observe" -l allow-missing-template-keys -d 'If true, ignore any errors in templates when a field or map key is missing in the template.' -x
...
complete -c oc -n "__fish_seen_subcommand_from observe" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from observe" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from observe" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from observe" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from observe" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from observe" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from observe" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from observe" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from observe" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from observe" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from observe" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from observe" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from observe" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from observe" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from observe" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from observe" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from observe" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from policy" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from policy" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from policy" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from policy" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from policy" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from policy" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from policy" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from policy" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from policy" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from policy" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from policy" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from policy" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from policy" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from policy" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from policy" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from policy" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from policy" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from image" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from image" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from image" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from image" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from image" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from image" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from image" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from image" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from image" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from image" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from image" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from image" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from image" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from image" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from image" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from image" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from image" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from idle" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from idle" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from idle" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from idle" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from idle" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from idle" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from idle" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from idle" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from idle" -l log-flush-frequency -d 'Maximum number of seconds between log flushes' -x
complete -c oc -n "__fish_seen_subcommand_from idle" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from idle" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from idle" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from idle" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from idle" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from idle" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from idle" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from idle" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from idle" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from api-resources" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from api-resources" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from api-resources" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from api-resources" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from api-resources" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from api-resources" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from api-resources" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from api-resources" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from api-resources" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from api-resources" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from api-resources" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from api-resources" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from api-resources" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from api-resources" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from api-resources" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from api-resources" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from diff" -s k -l kustomize -d 'Process the kustomization directory.' -x
complete -c oc -n "__fish_seen_subcommand_from diff" -s R -l recursive -d 'Process the directory used in -f, --filename recursively.' -x
...
complete -c oc -n "__fish_seen_subcommand_from diff" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from diff" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from diff" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from diff" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from diff" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from diff" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from diff" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from diff" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from diff" -l log-flush-frequency -d 'Maximum number of seconds between log flushes' -x
complete -c oc -n "__fish_seen_subcommand_from diff" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from diff" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from diff" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from diff" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from diff" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from diff" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from diff" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from diff" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from diff" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from kustomize" -l helm-command -d 'helm command (path to executable)' -x
complete -c oc -n "__fish_seen_subcommand_from kustomize" -l load-restrictor -d 'if set to \'LoadRestrictionsNone\', local kustomizations may load files from outside their root.' -x
...
complete -c oc -n "__fish_seen_subcommand_from kustomize" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from kustomize" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from kustomize" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from kustomize" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from kustomize" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from kustomize" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from kustomize" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from kustomize" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from kustomize" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from kustomize" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from kustomize" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from kustomize" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from kustomize" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from kustomize" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from kustomize" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from kustomize" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from logout" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from logout" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from logout" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from logout" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from logout" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from logout" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from logout" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from logout" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from logout" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from logout" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from logout" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from logout" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from logout" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from logout" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from logout" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from logout" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from logout" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from config" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from config" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from config" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from config" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from config" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from config" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from config" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from config" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from config" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from config" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from config" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from config" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from config" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from config" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from config" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from config" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from config" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
...
complete -c oc -n "__fish_seen_subcommand_from whoami" -l certificate-authority -d 'Path to a cert file for the certificate authority' -x
complete -c oc -n "__fish_seen_subcommand_from whoami" -l client-certificate -d 'Path to a client certificate file for TLS' -x
complete -c oc -n "__fish_seen_subcommand_from whoami" -l client-key -d 'Path to a client key file for TLS' -x
...
complete -c oc -n "__fish_seen_subcommand_from whoami" -l kubeconfig -d 'Path to the kubeconfig file to use for CLI requests.' -x
complete -c oc -n "__fish_seen_subcommand_from whoami" -l log-backtrace-at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from whoami" -l log-dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from whoami" -l log-file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from whoami" -l log-file-max-size -d 'Defines the maximum size a log file can grow to.' -x
...
complete -c oc -n "__fish_seen_subcommand_from whoami" -l log_backtrace_at -d 'when logging hits line file:N, emit a stack trace' -x
complete -c oc -n "__fish_seen_subcommand_from whoami" -l log_dir -d 'If non-empty, write log files in this directory' -x
complete -c oc -n "__fish_seen_subcommand_from whoami" -l log_file -d 'If non-empty, use this log file' -x
complete -c oc -n "__fish_seen_subcommand_from whoami" -l log_file_max_size -d 'Defines the maximum size a log file can grow to.' -x
complete -c oc -n "__fish_seen_subcommand_from whoami" -l loglevel -d 'Set the level of log output (0-10)' -x
complete -c oc -n "__fish_seen_subcommand_from whoami" -l logtostderr -d 'log to standard error instead of files' -x
...
complete -c oc -n "__fish_seen_subcommand_from whoami" -l skip-log-headers -d 'If true, avoid headers when opening log files' -x
complete -c oc -n "__fish_seen_subcommand_from whoami" -l skip_headers -d 'If true, avoid header prefixes in the log messages' -x
complete -c oc -n "__fish_seen_subcommand_from whoami" -l skip_log_headers -d 'If true, avoid headers when opening log files' -x
