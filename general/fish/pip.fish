...
complete -k -c pip -n __fish_use_subcommand -x -a index -d "Inspect information available from package indexes."
...
complete -c pip -n "__fish_seen_subcommand_from install" -l "check-build-dependencies" -d "Check the build dependencies when PEP517 is used."
complete -c pip -n "__fish_seen_subcommand_from install" -l "config-settings" -d "Configuration settings to be passed to the PEP 517 build backend." -x
complete -c pip -n "__fish_seen_subcommand_from install" -l "install-option" -d "Extra arguments to be supplied to the setup.py install command (use like --install-option=\"--install-scripts=/usr/local/bin\")." -r
...
complete -c pip -n "__fish_seen_subcommand_from install" -l "no-index" -d "Ignore package index (only looking at --find-links URLs instead)."
complete -c pip -n "__fish_seen_subcommand_from install" -s "f" -l "find-links" -d "If a URL or path to an html file, then parse for links to archives such as sdist (.tar.gz) or wheel (.whl) files." -r
...
complete -c pip -n "__fish_seen_subcommand_from install" -l "proxy" -d "Specify a proxy in the form scheme://[user:passwd@]proxy.server:port." -x
...
complete -c pip -n "__fish_seen_subcommand_from install" -l "exists-action" -d "Default action when a path already exists: (s)witch, (i)gnore, (w)ipe, (b)ackup, (a)bort." -r
...
complete -c pip -n "__fish_seen_subcommand_from download" -l "progress-bar" -d "Specify whether the progress bar should be used [on, off] (default: on)" -x
...
complete -c pip -n "__fish_seen_subcommand_from download" -l "check-build-dependencies" -d "Check the build dependencies when PEP517 is used."
...
complete -c pip -n "__fish_seen_subcommand_from download" -s "i" -l "index-url" -d "Base URL of the Python Package Index (default https://pypi.org/simple)." -r
...
complete -c pip -n "__fish_seen_subcommand_from download" -l "no-index" -d "Ignore package index (only looking at --find-links URLs instead)."
complete -c pip -n "__fish_seen_subcommand_from download" -s "f" -l "find-links" -d "If a URL or path to an html file, then parse for links to archives such as sdist (.tar.gz) or wheel (.whl) files." -r
...
complete -c pip -n "__fish_seen_subcommand_from download" -l "proxy" -d "Specify a proxy in the form scheme://[user:passwd@]proxy.server:port." -x
...
complete -c pip -n "__fish_seen_subcommand_from download" -l "exists-action" -d "Default action when a path already exists: (s)witch, (i)gnore, (w)ipe, (b)ackup, (a)bort." -r
...
complete -c pip -n "__fish_seen_subcommand_from uninstall" -l "proxy" -d "Specify a proxy in the form scheme://[user:passwd@]proxy.server:port." -x
...
complete -c pip -n "__fish_seen_subcommand_from uninstall" -l "exists-action" -d "Default action when a path already exists: (s)witch, (i)gnore, (w)ipe, (b)ackup, (a)bort." -r
...
complete -c pip -n "__fish_seen_subcommand_from freeze" -l "proxy" -d "Specify a proxy in the form scheme://[user:passwd@]proxy.server:port." -x
...
complete -c pip -n "__fish_seen_subcommand_from freeze" -l "exists-action" -d "Default action when a path already exists: (s)witch, (i)gnore, (w)ipe, (b)ackup, (a)bort." -r
...
complete -c pip -n "__fish_seen_subcommand_from list" -s "i" -l "index-url" -d "Base URL of the Python Package Index (default https://pypi.org/simple)." -r
...
complete -c pip -n "__fish_seen_subcommand_from list" -l "no-index" -d "Ignore package index (only looking at --find-links URLs instead)."
complete -c pip -n "__fish_seen_subcommand_from list" -s "f" -l "find-links" -d "If a URL or path to an html file, then parse for links to archives such as sdist (.tar.gz) or wheel (.whl) files." -r
...
complete -c pip -n "__fish_seen_subcommand_from list" -l "proxy" -d "Specify a proxy in the form scheme://[user:passwd@]proxy.server:port." -x
...
complete -c pip -n "__fish_seen_subcommand_from list" -l "exists-action" -d "Default action when a path already exists: (s)witch, (i)gnore, (w)ipe, (b)ackup, (a)bort." -r
...
complete -c pip -n "__fish_seen_subcommand_from show" -l "proxy" -d "Specify a proxy in the form scheme://[user:passwd@]proxy.server:port." -x
...
complete -c pip -n "__fish_seen_subcommand_from show" -l "exists-action" -d "Default action when a path already exists: (s)witch, (i)gnore, (w)ipe, (b)ackup, (a)bort." -r
...
complete -c pip -n "__fish_seen_subcommand_from check" -l "proxy" -d "Specify a proxy in the form scheme://[user:passwd@]proxy.server:port." -x
...
complete -c pip -n "__fish_seen_subcommand_from check" -l "exists-action" -d "Default action when a path already exists: (s)witch, (i)gnore, (w)ipe, (b)ackup, (a)bort." -r
...
complete -c pip -n "__fish_seen_subcommand_from config" -l "editor" -d "Editor to use to edit the file." -r
...
complete -c pip -n "__fish_seen_subcommand_from config" -l "proxy" -d "Specify a proxy in the form scheme://[user:passwd@]proxy.server:port." -x
...
complete -c pip -n "__fish_seen_subcommand_from config" -l "exists-action" -d "Default action when a path already exists: (s)witch, (i)gnore, (w)ipe, (b)ackup, (a)bort." -r
...
complete -c pip -n "__fish_seen_subcommand_from search" -l "proxy" -d "Specify a proxy in the form scheme://[user:passwd@]proxy.server:port." -x
...
complete -c pip -n "__fish_seen_subcommand_from search" -l "exists-action" -d "Default action when a path already exists: (s)witch, (i)gnore, (w)ipe, (b)ackup, (a)bort." -r
...
complete -c pip -n "__fish_seen_subcommand_from cache" -l "format" -d "Select the output format among: human (default) or abspath" -r
...
complete -c pip -n "__fish_seen_subcommand_from cache" -l "proxy" -d "Specify a proxy in the form scheme://[user:passwd@]proxy.server:port." -x
...
complete -c pip -n "__fish_seen_subcommand_from cache" -l "exists-action" -d "Default action when a path already exists: (s)witch, (i)gnore, (w)ipe, (b)ackup, (a)bort." -r
...
complete -c pip -n "__fish_seen_subcommand_from index" -l "platform" -d "Only use wheels compatible with <platform>." -x
complete -c pip -n "__fish_seen_subcommand_from index" -l "python-version" -d "The Python interpreter version to use for wheel and \"Requires-Python\" compatibility checks." -x
complete -c pip -n "__fish_seen_subcommand_from index" -l "implementation" -d "Only use wheels compatible with Python implementation <implementation>, e.g. 'pp', 'jy', 'cp', or 'ip'." -x
complete -c pip -n "__fish_seen_subcommand_from index" -l "abi" -d "Only use wheels compatible with Python abi <abi>, e.g. 'pypy_41'." -x
complete -c pip -n "__fish_seen_subcommand_from index" -l "ignore-requires-python" -d "Ignore the Requires-Python information."
complete -c pip -n "__fish_seen_subcommand_from index" -l "pre" -d "Include pre-release and development versions."
complete -c pip -n "__fish_seen_subcommand_from index" -l "no-binary" -d "Do not use binary packages." -x
complete -c pip -n "__fish_seen_subcommand_from index" -l "only-binary" -d "Do not use source packages." -x
complete -c pip -n "__fish_seen_subcommand_from index" -s "i" -l "index-url" -d "Base URL of the Python Package Index (default https://pypi.org/simple)." -r
complete -c pip -n "__fish_seen_subcommand_from index" -l "extra-index-url" -d "Extra URLs of package indexes to use in addition to --index-url." -x
complete -c pip -n "__fish_seen_subcommand_from index" -l "no-index" -d "Ignore package index (only looking at --find-links URLs instead)."
complete -c pip -n "__fish_seen_subcommand_from index" -s "f" -l "find-links" -d "If a URL or path to an html file, then parse for links to archives such as sdist (.tar.gz) or wheel (.whl) files." -r
complete -c pip -n "__fish_seen_subcommand_from index" -s "h" -l "help" -d "Show help."
...
complete -c pip -n "__fish_seen_subcommand_from index" -l "log" -d "Path to a verbose appending log." -r
complete -c pip -n "__fish_seen_subcommand_from index" -l "no-input" -d "Disable prompting for input."
complete -c pip -n "__fish_seen_subcommand_from index" -l "proxy" -d "Specify a proxy in the form scheme://[user:passwd@]proxy.server:port." -x
complete -c pip -n "__fish_seen_subcommand_from index" -l "retries" -d "Maximum number of retries each connection should attempt (default 5 times)." -x
complete -c pip -n "__fish_seen_subcommand_from index" -l "timeout" -d "Set the socket timeout (default 15 seconds)." -x
complete -c pip -n "__fish_seen_subcommand_from index" -l "exists-action" -d "Default action when a path already exists: (s)witch, (i)gnore, (w)ipe, (b)ackup, (a)bort." -r
complete -c pip -n "__fish_seen_subcommand_from index" -l "trusted-host" -d "Mark this host or host:port pair as trusted, even though it does not have valid or any HTTPS." -x
complete -c pip -n "__fish_seen_subcommand_from index" -l "cert" -d "Path to PEM-encoded CA certificate bundle." -r
complete -c pip -n "__fish_seen_subcommand_from index" -l "client-cert" -d "Path to SSL client certificate, a single file containing the private key and the certificate in PEM format." -r
complete -c pip -n "__fish_seen_subcommand_from index" -l "cache-dir" -d "Store the cache data in <dir>." -r
complete -c pip -n "__fish_seen_subcommand_from index" -l "no-cache-dir" -d "Disable the cache."
complete -c pip -n "__fish_seen_subcommand_from index" -l "disable-pip-version-check" -d "Don't periodically check PyPI to determine whether a new version of pip is available for download."
complete -c pip -n "__fish_seen_subcommand_from index" -l "no-color" -d "Suppress colored output."
complete -c pip -n "__fish_seen_subcommand_from index" -l "no-python-version-warning" -d "Silence deprecation warnings for upcoming unsupported Pythons."
complete -c pip -n "__fish_seen_subcommand_from index" -l "use-feature" -d "Enable new functionality, that may be backward incompatible." -x
complete -c pip -n "__fish_seen_subcommand_from index" -l "use-deprecated" -d "Enable deprecated functionality, that will be removed in the future." -x
...
complete -c pip -n "__fish_seen_subcommand_from wheel" -l "check-build-dependencies" -d "Check the build dependencies when PEP517 is used."
...
complete -c pip -n "__fish_seen_subcommand_from wheel" -l "progress-bar" -d "Specify whether the progress bar should be used [on, off] (default: on)" -x
complete -c pip -n "__fish_seen_subcommand_from wheel" -l "no-verify" -d "Don't verify if built wheel is valid."
complete -c pip -n "__fish_seen_subcommand_from wheel" -l "config-settings" -d "Configuration settings to be passed to the PEP 517 build backend." -x
...
complete -c pip -n "__fish_seen_subcommand_from wheel" -s "i" -l "index-url" -d "Base URL of the Python Package Index (default https://pypi.org/simple)." -r
...
complete -c pip -n "__fish_seen_subcommand_from wheel" -l "no-index" -d "Ignore package index (only looking at --find-links URLs instead)."
complete -c pip -n "__fish_seen_subcommand_from wheel" -s "f" -l "find-links" -d "If a URL or path to an html file, then parse for links to archives such as sdist (.tar.gz) or wheel (.whl) files." -r
...
complete -c pip -n "__fish_seen_subcommand_from wheel" -l "proxy" -d "Specify a proxy in the form scheme://[user:passwd@]proxy.server:port." -x
...
complete -c pip -n "__fish_seen_subcommand_from wheel" -l "exists-action" -d "Default action when a path already exists: (s)witch, (i)gnore, (w)ipe, (b)ackup, (a)bort." -r
...
complete -c pip -n "__fish_seen_subcommand_from hash" -l "proxy" -d "Specify a proxy in the form scheme://[user:passwd@]proxy.server:port." -x
...
complete -c pip -n "__fish_seen_subcommand_from hash" -l "exists-action" -d "Default action when a path already exists: (s)witch, (i)gnore, (w)ipe, (b)ackup, (a)bort." -r
...
complete -c pip -n "__fish_seen_subcommand_from completion" -s "p" -l "powershell" -d "Emit completion code for powershell"
...
complete -c pip -n "__fish_seen_subcommand_from completion" -l "proxy" -d "Specify a proxy in the form scheme://[user:passwd@]proxy.server:port." -x
...
complete -c pip -n "__fish_seen_subcommand_from completion" -l "exists-action" -d "Default action when a path already exists: (s)witch, (i)gnore, (w)ipe, (b)ackup, (a)bort." -r
...
complete -c pip -n "__fish_seen_subcommand_from debug" -l "proxy" -d "Specify a proxy in the form scheme://[user:passwd@]proxy.server:port." -x
...
complete -c pip -n "__fish_seen_subcommand_from debug" -l "exists-action" -d "Default action when a path already exists: (s)witch, (i)gnore, (w)ipe, (b)ackup, (a)bort." -r
