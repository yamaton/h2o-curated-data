...
complete -c procs -s W -l watch-interval -d 'Watch mode with custom interval' -x
complete -c procs -s i -l insert -d 'Insert column to slot' -x
complete -c procs -l only -d 'Specified column only' -x
complete -c procs -l sorta -d 'Sort column by ascending' -x
complete -c procs -l sortd -d 'Sort column by descending' -x
complete -c procs -s c -l color -d 'Color mode' -x
complete -c procs -l theme -d 'Theme mode' -x
