...
complete -c protoc -l encode -d 'Read a text-format message of the given type from standard input and write it in binary to standard output.' -x
complete -c protoc -l deterministic_output -d 'When using --encode, ensure map fields are deterministically ordered.'
complete -c protoc -l decode -d 'Read a binary message of the given type from standard input and write it in text format to standard output.' -x
...
complete -c protoc -l plugin -d 'Specifies a plugin executable to use.' -x
