...
complete -c rg -s "M" -l "max-columns" -d "Don\8217t print lines longer than this limit in bytes." -x
...
complete -c rg -l "no-heading" -d "Don\8217t group matches by each file."
complete -c rg -l "no-ignore" -d "Don\8217t respect ignore files (.gitignore, .ignore, etc.). This implies --no-ignore-dot, --no-ignore-exclude, --no-ignore-global, no-ignore-parent and --no-ignore-vcs."
...
complete -c rg -s "u" -l "unrestricted" -d "Reduce the level of \"smart\" searching." -r
