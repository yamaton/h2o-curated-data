...
complete -c robot -s F -l extension -d 'Parse only files with this extension when executing a directory.' -x
complete -c robot -s N -l name -d 'Set the name of the top level suite.' -x
complete -c robot -s D -l doc -d 'Set the documentation of the top level suite.' -x
complete -c robot -s M -l metadata -d 'Set metadata of the top level suite.' -x
...
complete -c robot -s R -l rerunfailed -d 'Select failed tests from an earlier output file to be re-executed.' -x
complete -c robot -s S -l rerunfailedsuites -d 'Select failed suites from an earlier output file to be re-executed.' -x
...
complete -c robot -s v -l variable -d 'Set variables in the test data.' -x
...
complete -c robot -l logtitle -d 'Title for the generated log file.' -x
complete -c robot -l reporttitle -d 'Title for the generated report file.' -x
complete -c robot -l reportbackground -d 'Background colors to use in the report file.' -x
complete -c robot -l maxerrorlines -d 'Maximum number of error message lines to show in report when tests fail.' -x
complete -c robot -s L -l loglevel -d 'Threshold level for logging.' -x
...
complete -c robot -l expandkeywords -d 'Matching keywords will be automatically expanded in the log file.' -x
complete -c robot -l removekeywords -d 'Remove keyword data from the generated log file.' -x
complete -c robot -l flattenkeywords -d 'Flattens matching keywords in the generated log file.' -x
complete -c robot -l listener -d 'A class for monitoring test execution.' -x
...
complete -c robot -s C -l consolecolors -d 'Use colors on console output or not.' -x
