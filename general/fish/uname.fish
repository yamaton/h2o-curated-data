...
complete -c uname -s "a" -l "all" -d "print all information, in the following order, except omit -p and -i if unknown:"
...
complete -c uname -l "version" -d "output version information and exit"
