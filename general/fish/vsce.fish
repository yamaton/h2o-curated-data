...
complete -c vsce -n "not __fish_seen_subcommand_from ls package publish unpublish ls-publishers delete-publisher login logout verify-pat show search" -s "V" -l "version" -d "output the version number"
complete -c vsce -n "not __fish_seen_subcommand_from ls package publish unpublish ls-publishers delete-publisher login logout verify-pat show search" -s "h" -l "help" -d "display help for command"
