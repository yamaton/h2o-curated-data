...
complete -c wc -l "files0-from" -d "read input from the files specified by NUL-terminated names in file F; If F is - then read names from standard input" -r
...
complete -c wc -l "version" -d "output version information and exit"
