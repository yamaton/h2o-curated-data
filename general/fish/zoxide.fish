...
complete -c zoxide -n "not __fish_seen_subcommand_from add import init query remove" -s "h" -l "help" -d "Print help information"
complete -c zoxide -n "not __fish_seen_subcommand_from add import init query remove" -s "V" -l "version" -d "Print version information"
